...
export interface PipelineEngineDeps {
    ...
    // N4c: post-processor for fact-checking during round loop
    readonly postProcessor?: DebatePostProcessor;
    // N4d: look up earlyExitConfidence from strategy definition (fallback 0.85)
    readonly getEarlyExitConfidence?: (topologyType: string) => number;
                    ...
                    switch (event.type) {
                        ...
                        case 'round:end': {
                            ...
                            if (interimClaims.length > 1) {
                                ...
                                // N4d: read earlyExitConfidence from strategy definition (fallback 0.85 for backward compat)
