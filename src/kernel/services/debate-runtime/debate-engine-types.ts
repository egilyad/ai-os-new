...
export interface DebateEngineDeps {
    ...
    // N4c: post-processor for fact-checking during round loop (pipeline builder awaits processFactCheck)
    ...
    getEarlyExitConfidence?: (topologyType: string) => number;
    ...
    argTech?: import('../../contracts/debateplus').IArgTechService;
