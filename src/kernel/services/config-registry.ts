...
export const rawConfig: ConfigRegistry = {
    ...
    router: {
        ...
        providerByComplexity: {
            ...
            medium: { provider: 'groq', model: 'meta-llama/llama-4-maverick-17b-128e-instruct' },
            default: { provider: 'groq', model: 'meta-llama/llama-4-scout-17b-16e-instruct' },
        },
    },
    ...
    services: {
        ...
        memory: { semanticEnabled: true, autoEmbedOnStore: true, maxEntries: 1000, ttlMs: 30 * 24 * 60 * 60 * 1000 },
    },
