...
export class CapabilityResolver implements ICapabilityResolver {
    constructor(_dal: DataAccessLayer, private persona?: IPersonaService, private skills?: ISkillMarketService, private tools?: IToolRunnerService, private gov?: IGovernanceService) { void _dal; }
