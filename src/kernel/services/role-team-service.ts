...
// Fallback: data/team-template-definitions missing — keep empty templates
...
export class RoleTeamService implements IRoleTeamService {
    ...
    private pickProviderAndKey(): { provider: string; key: string; model: string } | undefined {
        ...
        // Aug-2026: Groq deprecated llama-3.3-70b-versatile, NIM EOL'd llama-3.1-8b-instruct — use Llama 4
