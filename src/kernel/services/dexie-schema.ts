...
export class SuperAgentsDB extends Dexie {
    ...
    constructor() {
        ...
        // v44 — Remove `content` from memories index (content is large text, indexed for nothing).
        // Memory search uses BM25 in a Web Worker, not Dexie's index.
        this.version(44).stores({
            notes: 'id, keyId, type, timestamp',
            memories: 'id, [metadata.source], [metadata.type], [metadata.timestamp]',
            apiKeys: 'id, provider, status',
            sessions: 'id, title, updatedAt',
            roles: 'id, name, metadata.category',
            cognitiveTraces: 'id, traceId, startTime, status',
