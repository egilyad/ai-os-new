...
export class SuperAgentsDB extends Dexie {
    ...
    agentManaged!: Table<Record<string, unknown>>;
    agentSkills!: Table<Record<string, unknown>>;
    agentTools!: Table<Record<string, unknown>>;
    agentResponsibilities!: Table<Record<string, unknown>>;
    agentMetrics!: Table<Record<string, unknown>>;
    agentMemory!: Table<Record<string, unknown>>;
    agentExecutions!: Table<Record<string, unknown>>;
    agentConfigRevisions!: Table<Record<string, unknown>>;
    agentApiKeys!: Table<Record<string, unknown>>;
    agentBudgets!: Table<Record<string, unknown>>;
    budgetIncidents!: Table<Record<string, unknown>>;

    // Phase 2: Task System (AGEMS port)
    tasks!: Table<Record<string, unknown>>;
    taskLabels!: Table<Record<string, unknown>>;
    taskComments!: Table<Record<string, unknown>>;
    taskWorkProducts!: Table<Record<string, unknown>>;
    taskTriggers!: Table<Record<string, unknown>>;

    // Phase 3: Approval Workflow (AGEMS port)
    approvalPresets!: Table<Record<string, unknown>>;
    approvalRequests!: Table<Record<string, unknown>>;
    approvalComments!: Table<Record<string, unknown>>;
    meetings!: Table<Record<string, unknown>>;
    meetingDecisions!: Table<Record<string, unknown>>;
    meetingMessages!: Table<Record<string, unknown>>;
    catalogAgents!: Table<Record<string, unknown>>;
    catalogSkills!: Table<Record<string, unknown>>;
    auditLogs!: Table<Record<string, unknown>>;
    accessRules!: Table<Record<string, unknown>>;
    telegramChats!: Table<Record<string, unknown>>;
    telegramMessages!: Table<Record<string, unknown>>;
    n8nWorkflows!: Table<Record<string, unknown>>;
    mcpServers!: Table<Record<string, unknown>>;
    ...
    constructor() {
        ...
        // v36 — Agent Management (AGEMS port, Phase 0): additive, no upgrades.
        ...
        // v37 — Task System (AGEMS port, Phase 2): additive, no upgrades.
        this.version(37).stores({
            ...
            agentBudgets: 'id, agentId',
            budgetIncidents: 'id, budgetId',
            tasks: 'id, status, type, priority, assigneeId, creatorId, projectId, parentTaskId, createdAt',
            taskLabels: 'id, name',
            taskComments: 'id, taskId, authorType, authorId, createdAt',
            taskWorkProducts: 'id, taskId, type, createdBy, createdAt',
        });

        // v38 — Task Triggers (AGEMS port, Phase 2.8): additive, no upgrades.
        this.version(38).stores({
            ...
            taskComments: 'id, taskId, authorType, authorId, createdAt',
            taskWorkProducts: 'id, taskId, type, createdBy, createdAt',
            taskTriggers: 'id, taskId, slug, kind, enabled, createdAt',
        });

        // v39 — Approval Workflow (AGEMS port, Phase 3): additive, no upgrades.
        this.version(39).stores({
            ...
            taskWorkProducts: 'id, taskId, type, createdBy, createdAt',
            taskTriggers: 'id, taskId, slug, kind, enabled, createdAt',
            approvalPresets: 'id, preset, name, isDefault, createdAt',
            approvalRequests: 'id, agentId, toolName, category, riskLevel, status, presetId, createdAt',
            approvalComments: 'id, requestId, authorType, authorId, createdAt',
        });

        // v40 — Meetings (AGEMS port, Phase 5): additive, no upgrades.
        this.version(40).stores({
            ...
            approvalRequests: 'id, agentId, toolName, category, riskLevel, status, presetId, createdAt',
            approvalComments: 'id, requestId, authorType, authorId, createdAt',
            meetings: 'id, status, creatorId, scheduledAt, createdAt',
            meetingDecisions: 'id, meetingId, result, createdAt',
            meetingMessages: 'id, meetingId, authorId, timestamp',
        });

        // v41 — Catalog/Marketplace (AGEMS port, Phase 8): additive, no upgrades.
        this.version(41).stores({
            ...
            meetingDecisions: 'id, meetingId, result, createdAt',
            meetingMessages: 'id, meetingId, authorId, timestamp',
            catalogAgents: 'id, slug, type, authorOrg, downloads, createdAt',
            catalogSkills: 'id, slug, type, downloads, createdAt',
        });

        // v42 — Security + Audit (AGEMS port, Phase 9): additive, no upgrades.
        this.version(42).stores({
            ...
            catalogAgents: 'id, slug, type, authorOrg, downloads, createdAt',
            catalogSkills: 'id, slug, type, downloads, createdAt',
            auditLogs: 'id, actorType, actorId, action, resourceType, resourceId, createdAt',
            accessRules: 'id, agentId, resourceType, resourceId',
        });

        // v43 — Integrations (AGEMS port, Phase 10): additive, no upgrades.
        this.version(43).stores({
            ...
            auditLogs: 'id, actorType, actorId, action, resourceType, resourceId, createdAt',
            accessRules: 'id, agentId, resourceType, resourceId',
            telegramChats: 'id, agentId, telegramChatId, channelId, isApproved, createdAt',
            telegramMessages: 'id, chatId, messageId, direction, timestamp',
            n8nWorkflows: 'id, name, active, createdAt',
            mcpServers: 'id, name, status, createdAt',
        });
