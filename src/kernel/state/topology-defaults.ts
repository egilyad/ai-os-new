...
const NODES = normalizeAgentIdentity(
    assignArgumentStrategies(
        assignModelsToAgents([
            ...
            { id: 'agent-idea-generator', type: 'agent', label: 'Генератор идей', config: { roleName: 'Генератор идей', prompt: 'Ты — Генератор идей.', temperature: 0.8, tools: [], model: 'auto' } },
            { id: 'agent-critic-ru', type: 'agent', label: 'Критик', config: { roleName: 'Критик', prompt: 'Ты — Критик.', temperature: 0.3, tools: [], model: 'auto' } },
            { id: 'agent-analyst-ru', type: 'agent', label: 'Аналитик', config: { roleName: 'Аналитик', prompt: 'Ты — Аналитик.', temperature: 0.3, tools: [], model: 'auto' } },
            { id: 'agent-engineer-ru', type: 'agent', label: 'Инженер', config: { roleName: 'Инженер / Разработчик', prompt: 'Ты — Инженер.', temperature: 0.2, tools: [], model: 'auto' } },
            { id: 'agent-defender', type: 'agent', label: 'Адвокат', config: { roleName: 'Защитник решения', prompt: 'Ты — Адвокат.', temperature: 0.4, tools: [], model: 'auto' } },
            { id: 'agent-moderator-ru', type: 'agent', label: 'Модератор', config: { roleName: 'Модератор / Координатор', prompt: 'Ты — Модератор.', temperature: 0.3, tools: [], model: 'auto' } },
            { id: 'agent-researcher-ru', type: 'agent', label: 'Исследователь', config: { roleName: 'Исследователь / Факт-чекер', prompt: 'Ты — Исследователь.', temperature: 0.2, tools: [], model: 'auto' } },
            { id: 'agent-secretary', type: 'agent', label: 'Секретарь', config: { roleName: 'Секретарь / Детерминатор', prompt: 'Ты — Секретарь.', temperature: 0.2, tools: [], model: 'auto' } },
            { id: 'agent-erudite', type: 'agent', label: 'Эрудит', config: { roleName: 'Эрудит', prompt: 'Ты — Эрудит.', temperature: 0.4, tools: [], model: 'auto' } },
            { id: 'agent-organizer-ru', type: 'agent', label: 'Организатор', config: { roleName: 'Организатор', prompt: 'Ты — Организатор.', temperature: 0.3, tools: [], model: 'auto' } },
            { id: 'agent-expert-ru', type: 'agent', label: 'Эксперт', config: { roleName: 'Эксперт', prompt: 'Ты — Эксперт.', temperature: 0.3, tools: [], model: 'auto' } },
            { id: 'agent-communicator', type: 'agent', label: 'Коммуникатор', config: { roleName: 'Коммуникатор', prompt: 'Ты — Коммуникатор.', temperature: 0.4, tools: [], model: 'auto' } },
            { id: 'agent-entrepreneur', type: 'agent', label: 'Антрепренер', config: { roleName: 'Реализатор / Антрепренер', prompt: 'Ты — Антрепренер.', temperature: 0.5, tools: [], model: 'auto' } },
            { id: 'agent-arbitrator', type: 'agent', label: 'Арбитр', config: { roleName: 'Систематизатор / Арбитр', prompt: 'Ты — Арбитр.', temperature: 0.4, tools: [], model: 'auto' } },
            { id: 'agent-mathematician-ru', type: 'agent', label: 'Математик', config: { roleName: 'Математик', prompt: 'Ты — Математик.', temperature: 0.2, tools: [], model: 'auto' } },
            { id: 'agent-physicist', type: 'agent', label: 'Физик', config: { roleName: 'Физик', prompt: 'Ты — Физик.', temperature: 0.2, tools: [], model: 'auto' } },
            { id: 'agent-chemist-ru', type: 'agent', label: 'Химик', config: { roleName: 'Химик', prompt: 'Ты — Химик.', temperature: 0.2, tools: [], model: 'auto' } },
            { id: 'agent-biologist', type: 'agent', label: 'Биолог', config: { roleName: 'Биолог', prompt: 'Ты — Биолог.', temperature: 0.3, tools: [], model: 'auto' } },
            { id: 'agent-computer-scientist', type: 'agent', label: 'Информатик', config: { roleName: 'Информатик / Компьютерный учёный', prompt: 'Ты — Информатик.', temperature: 0.2, tools: [], model: 'auto' } },
            { id: 'agent-economist', type: 'agent', label: 'Экономист', config: { roleName: 'Экономист', prompt: 'Ты — Экономист.', temperature: 0.3, tools: [], model: 'auto' } },
            { id: 'agent-sociologist', type: 'agent', label: 'Социолог', config: { roleName: 'Социолог', prompt: 'Ты — Социолог.', temperature: 0.4, tools: [], model: 'auto' } },
            { id: 'agent-psychologist', type: 'agent', label: 'Психолог', config: { roleName: 'Психолог', prompt: 'Ты — Психолог.', temperature: 0.4, tools: [], model: 'auto' } },
            { id: 'agent-philosopher', type: 'agent', label: 'Философ', config: { roleName: 'Философ / Этик', prompt: 'Ты — Философ.', temperature: 0.5, tools: [], model: 'auto' } },
            { id: 'agent-lawyer-ru', type: 'agent', label: 'Юрист', config: { roleName: 'Юрист / Правовед', prompt: 'Ты — Юрист.', temperature: 0.2, tools: [], model: 'auto' } },
            { id: 'agent-doctor-ru', type: 'agent', label: 'Врач', config: { roleName: 'Врач / Биомедик', prompt: 'Ты — Врач.', temperature: 0.2, tools: [], model: 'auto' } },
...
export const AuditorTopology: ISTopology = {
    ...
    edges: [
        ...
        { id: 'e-idea-generator-agg', from: 'agent-idea-generator', to: 'aggregator', trigger: 'on_success' },
        ...
        { id: 'e-engineer-ru-agg', from: 'agent-engineer-ru', to: 'aggregator', trigger: 'on_success' },
        { id: 'e-defender-agg', from: 'agent-defender', to: 'aggregator', trigger: 'on_success' },
        { id: 'e-moderator-ru-agg', from: 'agent-moderator-ru', to: 'aggregator', trigger: 'on_success' },
        { id: 'e-researcher-ru-agg', from: 'agent-researcher-ru', to: 'aggregator', trigger: 'on_success' },
        { id: 'e-secretary-agg', from: 'agent-secretary', to: 'aggregator', trigger: 'on_success' },
        { id: 'e-erudite-agg', from: 'agent-erudite', to: 'aggregator', trigger: 'on_success' },
        { id: 'e-organizer-ru-agg', from: 'agent-organizer-ru', to: 'aggregator', trigger: 'on_success' },
        { id: 'e-expert-ru-agg', from: 'agent-expert-ru', to: 'aggregator', trigger: 'on_success' },
        { id: 'e-communicator-agg', from: 'agent-communicator', to: 'aggregator', trigger: 'on_success' },
        { id: 'e-entrepreneur-agg', from: 'agent-entrepreneur', to: 'aggregator', trigger: 'on_success' },
        { id: 'e-arbitrator-agg', from: 'agent-arbitrator', to: 'aggregator', trigger: 'on_success' },
        { id: 'e-mathematician-ru-agg', from: 'agent-mathematician-ru', to: 'aggregator', trigger: 'on_success' },
        { id: 'e-physicist-agg', from: 'agent-physicist', to: 'aggregator', trigger: 'on_success' },
        { id: 'e-chemist-ru-agg', from: 'agent-chemist-ru', to: 'aggregator', trigger: 'on_success' },
        { id: 'e-biologist-agg', from: 'agent-biologist', to: 'aggregator', trigger: 'on_success' },
        { id: 'e-computer-scientist-agg', from: 'agent-computer-scientist', to: 'aggregator', trigger: 'on_success' },
        ...
        { id: 'e-lawyer-ru-agg', from: 'agent-lawyer-ru', to: 'aggregator', trigger: 'on_success' },
        { id: 'e-doctor-ru-agg', from: 'agent-doctor-ru', to: 'aggregator', trigger: 'on_success' },
        ...
        { id: 'e-router-idea-generator', from: 'router', to: 'agent-idea-generator', trigger: 'data_flow' },
        ...
        { id: 'e-router-engineer-ru', from: 'router', to: 'agent-engineer-ru', trigger: 'data_flow' },
        { id: 'e-router-defender', from: 'router', to: 'agent-defender', trigger: 'data_flow' },
        { id: 'e-router-moderator-ru', from: 'router', to: 'agent-moderator-ru', trigger: 'data_flow' },
        { id: 'e-router-researcher-ru', from: 'router', to: 'agent-researcher-ru', trigger: 'data_flow' },
        { id: 'e-router-secretary', from: 'router', to: 'agent-secretary', trigger: 'data_flow' },
        { id: 'e-router-erudite', from: 'router', to: 'agent-erudite', trigger: 'data_flow' },
        { id: 'e-router-organizer-ru', from: 'router', to: 'agent-organizer-ru', trigger: 'data_flow' },
        { id: 'e-router-expert-ru', from: 'router', to: 'agent-expert-ru', trigger: 'data_flow' },
        { id: 'e-router-communicator', from: 'router', to: 'agent-communicator', trigger: 'data_flow' },
        { id: 'e-router-entrepreneur', from: 'router', to: 'agent-entrepreneur', trigger: 'data_flow' },
        { id: 'e-router-arbitrator', from: 'router', to: 'agent-arbitrator', trigger: 'data_flow' },
        { id: 'e-router-mathematician-ru', from: 'router', to: 'agent-mathematician-ru', trigger: 'data_flow' },
        { id: 'e-router-physicist', from: 'router', to: 'agent-physicist', trigger: 'data_flow' },
        { id: 'e-router-chemist-ru', from: 'router', to: 'agent-chemist-ru', trigger: 'data_flow' },
        { id: 'e-router-biologist', from: 'router', to: 'agent-biologist', trigger: 'data_flow' },
        { id: 'e-router-computer-scientist', from: 'router', to: 'agent-computer-scientist', trigger: 'data_flow' },
        ...
        { id: 'e-router-lawyer-ru', from: 'router', to: 'agent-lawyer-ru', trigger: 'data_flow' },
        { id: 'e-router-doctor-ru', from: 'router', to: 'agent-doctor-ru', trigger: 'data_flow' },
