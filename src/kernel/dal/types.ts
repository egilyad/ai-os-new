...
import type { CrewRepository } from './crew-repository';
import type { CouncilRepository } from './council-repository';
...
import type { InteropRepository } from './interop-repository';
import type { MetaRepository } from './meta-repository';
import type { TrustRepository } from './trust-repository';
import type { FrontierRepository } from './frontier-repository';
import type { ParityRepository } from './parity-repository';
import type { RivalRepository } from './rival-repository';
...
export interface DataAccessLayer {
    ...
    ops: OpsRepository;
    interop: InteropRepository;
    meta: MetaRepository;
    trust: TrustRepository;
    frontier: FrontierRepository;
    parity: ParityRepository;
    rival: RivalRepository;
    kv: KvRepository;
}
