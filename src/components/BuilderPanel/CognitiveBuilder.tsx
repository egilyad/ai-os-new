...
import { DesktopRecommended } from '../Layout/ResponsiveShell';
...
const CognitiveBuilder: React.FC = () => {
    ...
    return (
        ...
        >
            ...
            <DesktopRecommended title="Cognitive Builder — Desktop recommended" />
            <div
                style={{
                    flex: 1,
                    display: 'grid',
            ...
            >
                {!isMobile && <ComponentPalette onAddNode={addNode} t={t} />}
                ...
                {!isMobile ? (
                    ...
                    activeNode && (
                        <div style={{ position: 'fixed', left: 0, right: 0, bottom: 56, zIndex: 55, maxHeight: '45vh', overflowY: 'auto', background: 'var(--bg-panel)', borderTop: '1px solid var(--border)', borderRadius: '16px 16px 0 0', padding: '0.75rem' }}>
                            <InspectorPanel
                                activeNode={activeNode}
                                onUpdateLabel={updateNodeLabel}
                                onUpdateConfig={updateNodeConfig}
