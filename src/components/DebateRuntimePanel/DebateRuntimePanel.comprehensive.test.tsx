        ...
        const sessions = [
            {
                ...
                agentStates: [{ agentId: 'a1', nodeId: 'a1', phase: 'thinking' as const, round: 3, tokensUsed: 100, latency: 0, lastActiveAt: 0 }],
                totalTokens: 500,
                totalCost: 0.01,
                version: 1,
                startedAt: 0,
...
describe('SessionOverviewTab', () => {
    it('renders topology and agent states', async () => {
        ...
        const session = {
            ...
            agentStates: [
                { agentId: 'a1', nodeId: 'a1', phase: 'thinking' as const, round: 2, tokensUsed: 150, latency: 0, lastActiveAt: 0 },
                { agentId: 'a2', nodeId: 'a2', phase: 'idle' as const, round: 2, tokensUsed: 0, latency: 0, lastActiveAt: 0 },
            ],
            totalTokens: 500,
            totalCost: 0.02,
            version: 1,
        ...
        render(
            <AgentControlPanel
                session={{
                    ...
                    topology: { id: 't1', type: 'roundtable' as const, nodes: [], edges: [] },
                    agentStates: [
                        { agentId: 'agent-1', nodeId: 'agent-1', phase: 'idle', tokensUsed: 0, round: 1, latency: 0, lastActiveAt: 0 },
                        { agentId: 'agent-2', nodeId: 'agent-2', phase: 'thinking', tokensUsed: 100, round: 1, latency: 0, lastActiveAt: 0 },
                    ],
                    totalTokens: 100,
                    totalCost: 0.001,
                    version: 1,
        ...
        render(
            <AgentControlPanel
                session={{
                    ...
                    round: 1,
                    topology: { id: 't1', type: 'roundtable' as const, nodes: [], edges: [] },
                    agentStates: [{ agentId: 'agent-1', nodeId: 'agent-1', phase: 'idle', tokensUsed: 0, round: 1, latency: 0, lastActiveAt: 0 }],
                    totalTokens: 0,
                    totalCost: 0,
                    version: 1,
                    startedAt: 0,
        ...
        mockDebateEngine.getActiveSessions.mockReturnValue([
            {
                ...
                round: 2,
                topology: { id: 't1', type: 'roundtable' as const, nodes: [], edges: [] },
                agentStates: [{ agentId: 'a1', nodeId: 'a1', phase: 'thinking' as const, round: 2, tokensUsed: 200, latency: 0, lastActiveAt: 0 }],
                totalTokens: 500,
                totalCost: 0.005,
                version: 1,
                startedAt: 0,
