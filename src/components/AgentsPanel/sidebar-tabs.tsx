import { Settings, Zap, Cpu, Activity, Shield, BookOpen, RefreshCw, User, Info, Wrench } from 'lucide-react';
...
export const sidebarTabs: { id: TabId; label: string; icon: React.ReactNode }[] = [
    ...
    { id: 'management' as TabId, label: 'Skills & KPIs', icon: <Wrench size={18} /> },
