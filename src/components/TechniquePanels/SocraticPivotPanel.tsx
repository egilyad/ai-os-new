...
const TECHNIQUE_ID = 'socratic-pivot';
const CATEGORY = 'P1';
...
export const SocraticPivotPanel: React.FC = () => {
    ...
    return (
        <div style={{ padding: 16, display: 'flex', flexDirection: 'column', gap: 16, color: 'var(--slate-800, #1e293b)' }}>
            ...
            <FocusSection mode="qa" args={args} agents={agents} t={t} />
        </div>
    );
};

export default SocraticPivotPanel;
