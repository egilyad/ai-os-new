...
const TECHNIQUE_ID = 'evidence-triangulation';
const CATEGORY: string = 'P0';
...
export const EvidenceTriangulationPanel: React.FC = () => {
    ...
    return (
        <div style={{ padding: 16, display: 'flex', flexDirection: 'column', gap: 16, color: 'var(--slate-800, #1e293b)' }}>
            ...
            <FocusSection mode="claims" args={args} agents={agents} t={t} />
        </div>
    );
};

export default EvidenceTriangulationPanel;
