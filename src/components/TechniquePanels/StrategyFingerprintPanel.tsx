...
const TECHNIQUE_ID = 'strategy-fingerprint';
const CATEGORY: string = 'P2';
...
export const StrategyFingerprintPanel: React.FC = () => {
    ...
    return (
        <div style={{ padding: 16, display: 'flex', flexDirection: 'column', gap: 16, color: 'var(--slate-800, #1e293b)' }}>
            ...
            <FocusSection mode="agents" args={args} agents={agents} t={t} />
        </div>
    );
};

export default StrategyFingerprintPanel;
