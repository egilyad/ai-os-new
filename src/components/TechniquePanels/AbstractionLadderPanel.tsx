...
const TECHNIQUE_ID = 'abstraction-ladder';
...
export const AbstractionLadderPanel: React.FC = () => {
    ...
    return (
        <div style={{ padding: 16, display: 'flex', flexDirection: 'column', gap: 16, color: 'var(--slate-800, #1e293b)' }}>
            ...
            <FocusSection mode="metrics" args={args} agents={agents} t={t} />
        </div>
    );
};

export default AbstractionLadderPanel;
