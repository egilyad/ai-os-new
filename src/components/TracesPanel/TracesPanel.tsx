            ...
            >
                <div
                    style={{
                        ...
                        background: 'rgba(0,0,0,0.3)',
                        display: 'grid',
                        gridTemplateColumns: isMobile ? '110px 1fr 100px' : '150px 1fr 140px 120px 180px 100px',
                ...
                >
                    ...
                    {!isMobile && <span>{t('traces.table.status')}</span>}
                    {!isMobile && <span>{t('traces.table.steps')}</span>}
