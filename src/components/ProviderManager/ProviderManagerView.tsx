...
export type TabId = 'installed' | 'browse' | 'routing' | 'pools' | 'intel' | 'rotation';
export const TABS: TabId[] = ['installed', 'browse', 'routing', 'pools', 'intel', 'rotation'];
            ...
            <motion.div variants={containerVariants} initial="hidden" animate="show">
                ...
                {activeTab === 'installed' ? (
                    ...
                    <motion.div
                        variants={itemVariants}
                        role="tabpanel"
                        id="provider-panel-rotation"
                        aria-label="Rotation"
                    >
                        <ErrorBoundary variant="panel" name="Rotation">
                            <RotationView keys={keys} />
                        </ErrorBoundary>
                    </motion.div>
                )}
