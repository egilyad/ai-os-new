...
const nav: Record<string, string> = {
    ...
    'nav.section_knowledge_one': 'KNOWLEDGE',
    'nav.section_project_os': 'PROJECT OS',
    'nav.section_lenses': 'LENSES',
    'nav.section_crystals': 'CRYSTALS',
    'nav.section_junctions': 'JUNCTIONS',
    'nav.section_synthesis': 'SYNTHESIS',
    'nav.section_knowledge_generator': 'KNOWLEDGE GENERATOR',
    'nav.section_forum': 'FORUM',
    'nav.section_builder': 'BUILDER',
    'nav.section_director': 'DIRECTOR',
    'nav.section_room': 'ROOMS',
    'nav.section_projects': 'PROJECTS',
    'nav.section_settings': 'SETTINGS',
    'nav.overview': 'Overview',
    'nav.quick_access': 'Quick Access',
    'nav.chat': 'Chat',
    'nav.tasks': 'Tasks',
    'nav.tasks_board': 'Task board',
