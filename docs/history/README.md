...
| 2026-09-19 | Корень, 14 файлов: `CONVERSATION.md` (переписка 2026-09-06), `ROTATION.md` (T1.1 механика), `INVENTORY_REPORT.md`, статусы `COGNITIVE_AUX`/`FEDERATED_MEMORY` (2026-08-04), `TEN_SYSTEM_COMPARISON.md`, `SIMULATION_*` (2), `LEGACY_AGENT_PATHS.md`, `SESSION_LOG.md` (382 KB), `SUMMARY.md` (устаревшие цифры), `DEBATE_AUDIT_PROMPT_D1.md`, `debate-system-research.md`, `OPENCODE_RESEARCH.md`. В корне оставлен канон 39 файлов (панель DocsHealthPanel фетчит пути — см. `active/README.md`) | `docs/` |
